public class DecisionTreeExercise5 {
	 ...
	 * 
	 * Consult reviewer A first. If the opinion is favorable, then consult reviewer B. 
	 * If both are favorable, then publish.
	 * 
	 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		{
			...
			goAhead2.add(0.60491493d, failure2);			
