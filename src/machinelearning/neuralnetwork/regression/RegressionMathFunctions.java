package machinelearning.neuralnetwork.regression;
...
import machinelearning.neuralnetwork.regression.function.IMathFunction;
import machinelearning.neuralnetwork.regression.function.SinXDivXMathFunction;
...
public class RegressionMathFunctions {
    ...
    public static void main(final String[] args){
        ...
        final IMathFunction fn = new SinXDivXMathFunction();
     ...
     */
    private static DataSetIterator getTrainingData(final INDArray x, final IMathFunction function, final int batchSize, final Random rng) {
    ...
    //Plot the data
    private static void plot(final IMathFunction function, final INDArray x, final INDArray y, final INDArray... predicted) {
